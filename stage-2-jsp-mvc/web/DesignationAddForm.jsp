...
<script src='/stage2/js/DesignationAddForm.js'></script>
<h2>Designation (Add Module)</h2>
<span class='error'>
<jsp:getProperty name='errorBean' property='error' />
</span>
<form method='post' action='/stage2/AddDesignation.jsp' autocomplete='off' onsubmit='return validateForm(this)'>
<tm:FormID />
Designation
...
<form id='cancelAdditionForm' action='/stage2/Designations.jsp'></form>
