...
<script src='/stage2/js/ConfirmDeleteDesignation.js'></script>
<h2>Designation (Delete Module)</h2>
<form method='post' action='/stage2/DeleteDesignation.jsp' onsubmit='return validateForm(this)'>
<tm:FormID />
...
<form id='cancelDeletionForm' action='/stage2/Designations.jsp'></form>
