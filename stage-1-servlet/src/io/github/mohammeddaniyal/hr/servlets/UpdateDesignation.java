...
pw.println("<b>Designation Updated</b>");
pw.println("<br><br>");
...
pw.println("<form method='post' action='/stage1/updateDesignation' onsubmit='return validateForm(this)'>");
...
pw.println("</div>");
pw.println("<!-- Main container ends here-->");
pw.println("<form id='cancelEditingForm' action='/stage1/designationsView'></form>");
pw.println("</body>");
pw.println("</html>");
}
...
pw.println("<a href='/stage1/AddDesignation.html'>Add new Designation</a>");
pw.println("</th>");
pw.println("</tr>");
pw.println("<tr>");
...
pw.println("<td style='text-align:center'><a href='/stage1/editDesignation?code="+code+"'>Edit</a></td>");
pw.println("<td style='text-align:center'><a href='/stage1/confirmDeleteDesignation?code="+code+"'>Delete</a></td>");
pw.println("</tr>");
}
