...
pw.println("<form method='post' action='updateDesignation' onsubmit='return validateForm(this)'>");
...
pw.println("</div>");
pw.println("<!-- Main container ends here-->");
pw.println("<form id='cancelEditingForm' action='designationsView'></form>");
pw.println("</body>");
pw.println("</html>");
}
