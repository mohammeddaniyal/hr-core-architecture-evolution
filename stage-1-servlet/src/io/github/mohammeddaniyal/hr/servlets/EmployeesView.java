...
pw.println("<link rel='stylesheet' href='css/xray.css'>");
pw.println("<script src='js/xray.js'></script>");

pw.println("<script>");
pw.println("XRay.init({");
pw.println("title: 'Stage 1: Raw Servlets',");
pw.println("module: 'View Employees (Server-Side Rendering + Client Hydration)',");

pw.println("impact: [");
pw.println("'Full Page Reload: Entire document regenerated on each navigation.',");
pw.println("'Server-Side Rendering: Servlet builds HTML and injects JavaScript objects dynamically.',");
pw.println("'Data Hydration Pattern: Employee list serialized into JS array at page load.',");
pw.println("'No Incremental Fetching: All employee data transferred upfront regardless of interaction.',");
pw.println("'DAO Join Query: Employee and Designation combined at database layer.'");
pw.println("],");

pw.println("successFlow: [");
pw.println("{ location: 'client', type: 'request', message: '1. User clicks Employees link from index page.' },");
pw.println("{ location: 'server', type: 'request', message: '2. Tomcat routes request to EmployeesView servlet.' },");
pw.println("{ location: 'server', type: 'process', message: '3. Servlet calls EmployeeDAO.getAll().' },");
pw.println("{ location: 'database', type: 'process', message: '4. DAO executes JOIN query to fetch employees with designation details.' },");
pw.println("{ location: 'server', type: 'process', message: '5. Servlet dynamically builds HTML table and injects employee data into JavaScript array.' },");
pw.println("{ location: 'client', type: 'response', message: '6. Browser loads full page. Client-side JS enables row selection and detail panel updates without additional server calls.' }");
pw.println("],");

pw.println("errorFlow: [");
pw.println("{ location: 'client', type: 'request', message: '1. User clicks Employees link.' },");
pw.println("{ location: 'server', type: 'process', message: '2. Servlet attempts to fetch data via EmployeeDAO.' },");
pw.println("{ location: 'database', type: 'error', message: '3. Database connection or query execution fails.' },");
pw.println("{ location: 'server', type: 'error', message: '4. Exception propagates to servlet and is minimally handled.' },");
pw.println("{ location: 'client', type: 'response', message: '5. Browser may display blank or default error page due to limited centralized exception handling in Stage 1.' }");
pw.println("]");
pw.println("});");
pw.println("</script>");
