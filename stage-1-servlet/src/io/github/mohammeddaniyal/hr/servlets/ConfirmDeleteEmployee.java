...
pw.println("<form method='post' action='/stage1/deleteEmployee' onsubmit='return validateForm(this)'>");
...
pw.println("<form id='cancelDeletingForm' action='/stage1/employeesView'></form>");
pw.println("</body>");
pw.println("</html>");
