...
pw.println("<form method='post' action='deleteDesignation' onsubmit='return validateForm(this)'>");
...
pw.println("<form id='cancelDeletingForm' action='designationsView'></form>");
pw.println("</body>");
pw.println("</html>");
...
pw.println("<td style='text-align:center'><a href='deleteDesignation?code="+code+"'>Delete</a></td>");
pw.println("</tr>");
}
