...
pw.println("<form method='post' action='/stage1/deleteDesignation' onsubmit='return validateForm(this)'>");
...
pw.println("<form id='cancelDeletingForm' action='/stage1/designationsView'></form>");
pw.println("</body>");
pw.println("</html>");
...
pw.println("<td style='text-align:center'><a href='/stage1/deleteDesignation?code="+code+"'>Delete</a></td>");
pw.println("</tr>");
}
