...
pw.println("module: 'Add Employee (Synchronous Validation + Mutation)',");

pw.println("impact: [");
pw.println("'Synchronous Form Submission: Browser blocks until server responds.',");
pw.println("'Monolithic Servlet Logic: Controller, validation, and view rendering combined in one class.',");
pw.println("'Manual Server-Side Validation: Duplicate PAN and Aadhaar checks executed before insert.',");
pw.println("'Full Page Regeneration: Entire form rebuilt on validation failure.',");
pw.println("'No PRG Pattern: Page refresh may resubmit employee insertion.',");
pw.println("'DAO Layer Isolation: Database constraints handled in EmployeeDAO.'");
pw.println("],");

pw.println("successFlow: [");
pw.println("{ location: 'client', type: 'request', message: '1. User fills form and submits synchronously.' },");
pw.println("{ location: 'server', type: 'request', message: '2. Servlet extracts parameters and parses input data.' },");
pw.println("{ location: 'server', type: 'process', message: '3. Business validations performed (designation existence, PAN uniqueness, Aadhaar uniqueness).' },");
pw.println("{ location: 'database', type: 'process', message: '4. DAO executes INSERT after validation passes.' },");
pw.println("{ location: 'server', type: 'response', message: '5. Servlet generates confirmation HTML page.' },");
pw.println("{ location: 'client', type: 'response', message: '6. Browser reloads entire page and displays success message.' }");
pw.println("],");

pw.println("errorFlow: [");
pw.println("{ location: 'client', type: 'request', message: '1. User submits employee form.' },");
pw.println("{ location: 'server', type: 'process', message: '2. Validation detects duplicate PAN, Aadhaar, or invalid designation.' },");
pw.println("{ location: 'server', type: 'response', message: '3. Servlet rebuilds entire form with error messages injected dynamically.' },");
pw.println("{ location: 'client', type: 'response', message: '4. Browser reloads full page showing validation errors.' }");
pw.println("]");
pw.println("});");
pw.println("</script>");
...
pw.println("<td><input type='text' id='aadharCardNumber' name='aadharCardNumber' maxlength='12' size='13'>");
